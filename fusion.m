...
Max_y = max([max(Box1(:,2)) max(Box2(:,2))]);
...
% Box1(:,1) = Box1(:,1) + min(Box2(:,1));
% Box1(:,2) = Box1(:,2) + min(Box2(:,2));
% Box2(:,1) = Box2(:,1) + min(Box1(:,1));
% Box2(:,2) = Box2(:,2) + min(Box1(:,2));

%%
C_x1 = min(Box1(:,1))-Min_x+1:min(Box1(:,1))-Min_x+w1;
C_y1 = min(Box1(:,2))-Min_y+1:min(Box1(:,2))-Min_y+h1;

C_x2 = min(Box2(:,1))-Min_x+1:min(Box2(:,1))-Min_x+w2;
C_y2 = min(Box2(:,2))-Min_y+1:min(Box2(:,2))-Min_y+h2;
